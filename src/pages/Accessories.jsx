...
const Accessories = () => {
  ...
  useEffect(() => {
    fetchData2().then((products) => SetApi(products));
  }, []);
  console.log(api);
      ...
      <div className="flex gap-[84px]">
        <aside className="mt-[64px] w-[301px]">
          ...
          <ul className="mt-[48px]">
            ...
            <NavLink
              to="/Jewelery"
              className="active:text-[#ED165F] cursor-pointer text-[#686868] transition-all"
            >
              Jewelry
            </NavLink>
            <li className="active:text-[#ED165F] cursor-pointer mb-4 mt-4 text-[#686868] transition-all">
              Watches
            </li>
            <li className="active:text-[#ED165F] cursor-pointer mb-4 text-[#686868] transition-all">
              Hair accessories
          ...
          <hr className="w-full" />
          <ul className="grid grid-cols-4 mt-[32px] max-md:grid-cols-3">
            <li className="border flex justify-center py-[7px] w-[54px] mb-4 border-black cursor-pointer hover:bg-[#ED165F] transition-all duration-500 hover:text-white max-md:w-8">
              XS
            </li>
            <li className="border flex justify-center py-[7px] w-[54px] mb-4 border-black cursor-pointer hover:bg-[#ED165F] transition-all duration-500 hover:text-white max-md:w-8">
              S
